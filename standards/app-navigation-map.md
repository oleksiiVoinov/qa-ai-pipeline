...
<!-- Regenerated by ab-app-map from Android-automation-test @ 05fa779 (2026-06-16). -->
...
SPLIT_TUNNELLING, SETTINGS, CONNECTION_FAILED, ALLWAYSVPN, KILL_SWITCH,
LOADING_SCREEN, APP_NOT_RESPONDING.
...
Kill Switch (→ KILL_SWITCH), Privacy Notice, Terms of Service.

### Kill Switch (KILL_SWITCH)
Reach: Settings → tap Kill Switch.
Actions: enable/disable toggle, assert toggle on/off, back, validate page.
